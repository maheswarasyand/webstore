            ...
            <div class="grid grid-cols-1 gap-10 pr-6 border-r border-gray-200 md:col-span-3">
                <div>
                    ...
                    @error('select_collections.*')
                        <div class="text-mx text-red-500">
                            {{ $message }}
                        </div>
                    @enderror
                    ...
                    <div class="grid grid-cols-2 mt-10">
                        <button type="button" wire:click="applyFilters" wire:loading.attr="disabled"
                            ...
                            Apply Filter
                            <div class="animate-spin inline-block size-4 border-3 border-current border-t-transparent text-white rounded-full dark:text-white"
                                role="status" wire:loading aria-label="loading">
            ...
            <div class="col-span-1 md:col-span-7">
                <div class="flex items-center justify-between gap-5">
                    ...
                    <div class="flex items-center gap-2">
                        <span class="flex flex-col items-endtext-sm font-light text-gray-800 dark:text-neutral-200">
                            Sort By :
                            @error('sort_by')
                                <div class="text-xs text-red-500">
                                    {{ $message }}
